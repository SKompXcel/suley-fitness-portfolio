...
const experiences = [
  {
    ...
    bullets: [
      ...
      'Certified it against the booking system of record by reconciling 40+ funded deals to the cent, reproducing every booked cash-flow vector and proving the NPV and IRR identities on the actual flows, not its own output. Gated every change behind a 1,440-test suite with mutation-tested assertions, 42 deal fixtures kept server-only, and 5 expected-fail tests holding known gaps open; it caught 7 of 9 engines silently quoting wrong terms.',
